export 'package:bayer/costante/app_colors.dart';
export 'package:flutter/material.dart';
export 'package:get/get.dart';
export 'package:google_fonts/google_fonts.dart';
export 'package:bayer/views/splash.dart';
export 'package:flutter_easyloading/flutter_easyloading.dart';
export 'package:bayer/costante/extension.dart';
export 'package:bayer/rensponsive/rensponsive.dart';
export 'package:bayer/views/locataire/locataire_view.dart';
export 'package:bayer/views/owner_dashboard.dart';
...
export 'package:bayer/widget/search_widget.dart';
